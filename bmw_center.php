...
<head>
    ...
    <link rel="stylesheet" href="bmw1.css">
...
<body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="menu">
                            ...
                            <ul>
                                <li><a href="bmw_zapad.php">Западный Административный округ</a></li>
                                <li><a href="bmw_center.php">Центральный Административный округ</a></li>
                                <li><a href="bmw_yg.php">Южный Административный округ</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="wrapper">
        ...
        $sql_map = "SELECT `Location`,`name`,`AdminstrArea`,`Address` FROM `database` where car=4 and AdminstrArea='Центральный административный округ'";
