...
<body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="menu">
                            ...
                            <ul>
                                <li><a href="tesla_zapad.php">Западный Административный округ</a></li>
                                <li><a href="tesla_center.php">Центральный Административный округ</a></li>
                                <li><a href="tesla_yg.php">Южный Административный округ</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="wrapper">
        ...
        $sql_map = "SELECT `Location`,`name`,`AdminstrArea`,`Address` FROM `database` where car=5 and AdminstrArea='Центральный административный округ'";
