...
<head>
    ...
    <link rel="stylesheet" href="porshe1.css">
...
<body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="menu">
                            ...
                            <ul>
                                <li><a href="porshe_zapad.php">Западный Административный округ</a></li>
                                <li><a href="porshe_center.php">Центральный Административный округ</a></li>
                                <li><a href="porshe_yg.php">Южный Административный округ</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="wrapper">
        ...
        $sql_map = "SELECT `Location`,`name`,`AdminstrArea`,`Address` FROM `database` where car=3 and AdminstrArea='Центральный административный округ'";
