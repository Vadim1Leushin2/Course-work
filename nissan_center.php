...
<head>
    ...
    <link rel="stylesheet" href="nissan1.css">
...
<body>
    ...
    <div class="wrapper">
        ...
        $sql_map = "SELECT `Location`,`name`,`AdminstrArea`,`Address` FROM `database` where car=2 and AdminstrArea='Центральный административный округ'";
